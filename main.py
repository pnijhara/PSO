		...
		while True: 
			...
			for j in range(0,num_particles):
				...
				if swarm[j].error < global_best_error or global_best_error == -1:
					...
					plt.title("PSO Algorithm, Particles:{}, Error:{}".format(num_particles,round(global_best_error,1)))
...
Interactive_PSO(fitness_function,initial,bounds,num_particles=32)# let say 2 particles and 50 iterations
